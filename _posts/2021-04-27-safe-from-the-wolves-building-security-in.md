...
user: timlee
author: Tim Lee
excerpt: Last week I virtually attended the reasonably interesting <a href="https://devopscon.io/london">DevOpsCon London</a> event. My main takeaway is that _Shift Left on Security_ is the current buzz-phrase in the DevOps community, with some suggesting an expansion of the existing merger to create <i>DevSecOps</i>.
---
